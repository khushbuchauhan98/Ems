...
namespace Ems1.Controllers
{
    ...
    public class LeaveRequestController : Controller
    {
        ...
        public async Task<ActionResult> MyLeave()
        {
            ...
            //var abc = _applicationDbContext.LeaveRequests.Where(x => x.RequestingEmployeeId == employeeid).ToList();
        ...
        public async Task<ActionResult> Create()
        {
           ...
           // ViewBag.Semts = new SelectList(_applicationDbContext.LeaveTypes.ToList(), "Id", "SemtAd");
        ...
        //    var abc = (from LeaveType in _applicationDbContext.LeaveTypes
        ...
        //               }).ToList();
        //    abc.Insert(0, new SelectListItem()
        //    {
        //        Text="---",
        //        Value=String.Empty
        //    });
        ...
        //}
        //[HttpPost]
        //public async Task<ActionResult> Create1(CreateLeaveRequestVM model)
        //{
